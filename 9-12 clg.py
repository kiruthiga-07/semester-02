...
class Parent(Student):
    ...
    def display_parent(self):
        print(f"Mother Name:{self.mother_nname}\nFather Name:{self.father_name}")
class Contact(Student):
    def __init__(self,mother_no,father_no):
        self.mother_no=mother_no
        self.father_no=father_no
    def display_contact(self):
        print(f"Mother Number:{self.mother_no}\nFather Number:{self.father_no}")
"""       
#
class person:
    def __init__(self,name,age):
...
class display_details(student,Employee,person):
    ...
    def display_all(self):
        ...
        self.student_info()
        self.Employee_info()
m=display_details("Kiruthiga",18,"E24AI003",207645)
m.display_all()
